...
function createMarkdownWidget(node2, config) {
  ...
  copyButton.addEventListener("click", (e2) => {
    e2.stopPropagation();
...
_MarkdownRendererNode.category = "storyboard/Markdown";
_MarkdownRendererNode._category = "storyboard/Markdown";
